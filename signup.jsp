...
%>  
 ...
 res1=st.executeQuery("select username from details where username='"+un+"'"); 
 while(res1.next()){
 c++; 
 }
      if(pass.equals(cpass) && c==0)
      {
 res=st.executeUpdate("insert into details(name,email,username,password) values('"+n+"','"+e+"','"+un+"','"+pass+"')");
